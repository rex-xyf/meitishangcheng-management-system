...
//            properties.put("mail.smtp.ssl.socketFactory", sf);
            ...
            // 2.3设置邮件主题
            message.setSubject("Finding Password");
            // 2.4设置邮件内容
            String content = "<html><head></head><body><h1>Dear user!<br>" +
                    "<h3>You are retrieving your password. If you do not perform this operation, please ignore</h3>" +
                    "<h3>Please click the link below to recreate your password</h3>"+
                    "</h1><h3>http://localhost:8080/meitishangcheng-system/find.html?code="+actcode+"<br>----form metishangcheng-system</h3></body></html>";
